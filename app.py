...
6. 답변은 너무 딱딱하지 않게, “짧은 공감 한 문장 → 결론 1줄 → 근거/절차 안내” 순서로 작성하세요.
7. 문서에 없는 내용은 절대 추측하지 말고, 대신 확인 불가 안내 + 다음 행동(어디에 문의/어떤 정보 필요)을 제시하세요.
8. 과장된 표현은 피하고, 친절하지만 간결하게 작성하세요.
...
st.divider()
st.caption("본 챗봇은 AI 기반으로 작동하며, 정확한 내용은 넥스트챌린지에 확인해주세요.")
